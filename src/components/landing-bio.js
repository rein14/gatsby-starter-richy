...
const LandingBio = () => (
  <StaticQuery
    ...
    render={data => (
      <OuterContainer>
        <Container>
<img alt='' style={{'borderRadius':'100px','max-width':'100%'}} src='https://avatars.githubusercontent.com/u/8625033?s=400&u=62eea254a73c46af79de517088e8c8ac641998d5&v=4'></img>
